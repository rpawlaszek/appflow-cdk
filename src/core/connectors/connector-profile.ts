...
export abstract class ConnectorProfileBase extends Resource implements IConnectorProfile {
   ...
   * @experimental
   */
  protected static _fromConnectorProfileName(scope: Construct, id: string, name: string): IConnectorProfile {
    return ConnectorProfileBase._fromConnectorProfileAttributes(scope, id, { name });
  }
   ...
   * @experimental
   */
  protected static _fromConnectorProfileArn(scope: Construct, id: string, arn: string): IConnectorProfile {
    return ConnectorProfileBase._fromConnectorProfileAttributes(scope, id, { arn });
  }
